...
TEST_CASE("convolution_multidata")
{
	...
	SECTION("convolution data vs validate data."){
		...
		for(int i = 0; i < 100; ++i)
			blob_tools::read_data2blob(b,"/home/seal/cuda-workspace/CACUE/core/test/python/conv/feature_map.txt",i);
		...
		for(int i = 0; i < 100; ++i)
			blob_tools::read_data2blob(validate_,"/home/seal/cuda-workspace/CACUE/core/test/python/conv/conv_result.txt",i);
...
TEST_CASE("convolution_grad")
{
	...
	SECTION("convolution grad data vs validate data."){
		...
		blob_tools::read_data2blob(b,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/feature_map.txt");
		...
		convolution_op *op = (convolution_op *)operator_factory::create_op(CACU_CONVOLUTION,input,args_);
		blob_tools::read_data2blob(op->get_weight(0),"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/kernel.txt");

		blob *output = (blob*)op->out_data();
		blob_tools::read_diff2blob(output,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/grad_map.txt");
		...
		blob_tools::read_data2blob(validate_,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/conv_grad_result.txt");

		blob *validate_k = cacu_allocator::create_blob(32, 3, 3, 3,test);
		blob_tools::read_data2blob(validate_k,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/fgrad.txt");
		blob *validate_b = cacu_allocator::create_blob(32, 1, 1, 1,test);
		blob_tools::read_data2blob(validate_b,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/bgrad.txt");
...
TEST_CASE("convolution_grad_multidata")
{
	...
	SECTION("convolution grad data vs validate data."){
		...
		for(int i = 0 ; i< 100; ++i)
			blob_tools::read_data2blob(b,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/feature_map.txt",i);
		...
		blob *output = (blob*)op->out_data();
		for(int i = 0 ; i< 100; ++i)
			blob_tools::read_diff2blob(output,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/grad_map.txt",i);
		...
		for(int i = 0; i < 100; ++i)
			blob_tools::read_data2blob(validate_,"/home/seal/cuda-workspace/CACUE/core/test/python/conv_grad/conv_grad_result.txt",i);
